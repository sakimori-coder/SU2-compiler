...
struct U2Dzeta8 {
    ...
    U2Dzeta8(Matrix2Zzeta8 _mat, int _k);
    U2Dzeta8(ring::Zzeta8j q, int l, int _k) : U2Dzeta8(q.u, q.t, l, _k) {}
    U2Dzeta8(ring::Zzeta8 u, ring::Zzeta8 t, int l, int _k);
