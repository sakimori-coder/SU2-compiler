...
static const SO3Droot2 H_SO3 = H_U2.to_SO3Droot2();
static const SO3Droot2 S_SO3 = S_U2.to_SO3Droot2();
static const SO3Droot2 Sinv_SO3 = S_SO3.transpose();
static const SO3Droot2 T_SO3 = T_U2.to_SO3Droot2();
...
//  implement SO3Droot2
//==============================================================================
SO3Droot2::SO3Droot2(Matrix3Zroot2 _mat, int _k) {
	mat = _mat;
	k = _k;
...
[[nodiscard]] SU2 U2Dzeta8::to_SU2() const {
	int l;
...
[[nodiscard]] SO3Droot2 U2Dzeta8::to_SO3Droot2() const {
	Matrix2Zzeta8 mat_dag;
	mat_dag << mat(0,0).conj_complex(), mat(1,0).conj_complex(),
			   mat(0,1).conj_complex(), mat(1,1).conj_complex();
...
int get_Tcount(const U2Dzeta8& U) {
	SO3Droot2 U_SO3 = U.to_SO3Droot2();
	return int(U_SO3.k);
}
