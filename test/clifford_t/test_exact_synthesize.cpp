...
using su2compiler::clifford_t::U2Dzeta8;

TEST(CliffordTExactsynthesis, Ross_paper) {
    ...
    std::string seq2 = clifford_t::exact_synthesis(U);
    EXPECT_EQ(seq1, seq2);
}

TEST(CliffordTExactsynthesis, Identity) {
    Zzeta8 u(1);
    Zzeta8 t(0);
    UINT k = 0;
    U2Dzeta8 U(u, t, 0, k);
...
TEST(CliffordTExactsynthesis, T) {
    Zzeta8 u(1);
    Zzeta8 t(0);
    int k = 0;
    U2Dzeta8 U(u, t, 1, k);
